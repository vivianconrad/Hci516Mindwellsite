  ...
  return (
    <div className="bg-[#fffcf2] h-[68px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[22px] pr-[556.531px] py-[2px] relative size-full">
          <Text />
        </div>
      </div>
    </div>
...
function Text1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[86.766px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[24px] left-0 text-[#2b2675] text-[15px] top-0 whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
          Several days
        </p>
...
function Container7() {
  return (
    <div className="bg-[#fffcf2] h-[68px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e6eaff] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[22px] pr-[531.234px] py-[2px] relative size-full">
          <Text1 />
        </div>
      </div>
    </div>
...
function Text2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[163.469px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[24px] left-0 text-[#2b2675] text-[15px] top-0 whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
...
function Container8() {
  return (
    <div className="bg-[#fffcf2] h-[68px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e6eaff] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[22px] pr-[454.531px] py-[2px] relative size-full">
          <Text2 />
        </div>
      </div>
    </div>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2/15">
      <SelfAssessmentFlow />
      <SelfAssessmentFlow1 />
    </div>
  );
